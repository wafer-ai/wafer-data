# Copied from https://github.com/flashinfer-ai/flashinfer/blob/a2d6d49822df7f07a84c792fc7d1b421ad6198b9/tests/utils/test_fp4_quantize.py
import functools
...
SHAPES = [(128, 64), (256, 128), (120, 64), (200, 256), (2048, 2048), (128, 14336)]
BATCH_SHAPES = [
    (1, 256, 128),
    (2, 128, 64),
    (3, 256, 128),
